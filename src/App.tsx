import { 
  ...
  CheckCircle2, Globe, Printer, Cpu, HelpCircle, MessageCircle,
      ...
      <main className="relative z-10 pt-20">
        ...
        <section className="max-w-7xl mx-auto px-6 pt-16 pb-24 lg:pt-24 text-center">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 animate-in fade-in slide-in-from-bottom-10 duration-700 delay-300">
            {/* EL ENLACE CORRECTO PARA DESCARGAR EL APK */}
          ...
          <div className="max-w-7xl mx-auto px-6">
             ...
             <div className="grid md:grid-cols-3 gap-8 max-w-5xl mx-auto">
               <div className="bg-stone-900 border border-white/5 p-8 rounded-[2.5rem] flex flex-col hover:border-white/20 transition-all duration-500">
                 ...
                 <button className="w-full py-4 bg-white/5 border border-white/10 rounded-2xl font-bold hover:bg-white/10 transition-all">Elegir Plan</button>
               </div>
               ...
               <div className="bg-gradient-to-b from-indigo-600 to-indigo-900 p-8 rounded-[2.5rem] flex flex-col transform md:scale-110 shadow-3xl shadow-indigo-600/30 relative overflow-hidden">
                 ...
                 <button className="w-full py-4 bg-white text-indigo-600 rounded-2xl font-black shadow-lg hover:bg-stone-100 transition-all">Obtener Oferta</button>
               </div>
